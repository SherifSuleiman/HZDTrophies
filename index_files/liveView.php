		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?schain=1.0,1!network-n.com,pa_bee9082e,1&playerApiId=netw0rkN&cbuster=1770660901414&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Fpsnprofiles.com%2Ftrophies%2F5879-horizon-zero-dawn%2FSheriffSullivan&s=108267&cbuster=1770662538',
					origQString: 'schain=1.0,1!network-n.com,pa_bee9082e,1&playerApiId=netw0rkN&cbuster=1770660901414&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Fpsnprofiles.com%2Ftrophies%2F5879-horizon-zero-dawn%2FSheriffSullivan&s=108267',
					placementId: 108267,
					x: 640,
					y: 440,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"144.0.0.0","browserVersionMajor":"144","browserVersionMinor":"0","chromeVersion":"144"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'EG',
					dmaCode: 0,
					dynamicSetup: [],
					...
					allowedUtmParameters: ["utm_source"],
					allowDisplaySamePlacementAgain: true,
					blockOtherPlacements: false,
					searchMetaTagNames: false,
					customTargetingProperties: {"objectType":"window","objectFunction":"nnads.meta","commitDoubleEncoding":1,"source":"WindowObject"},
